# BAX entry point for the shared H-score analysis workflow.
...
options(
  hscore.marker_name = "BAX",
  hscore.script_index = "01",
  hscore.primary_test = "paired_t",
  hscore.input_filename = file.path("data", "processed", "BAX_Hscore_deidentified.csv"),
